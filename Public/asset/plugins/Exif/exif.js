...
(function () {
	...
	function r(i, o) {
		function t(e) {
			...
			var n = (function (e) {
				...
				for (; n < r; ) {
					if (
						((l = n), 56 === (s = t).getUint8(l) && 66 === s.getUint8(l + 1) && 73 === s.getUint8(l + 2) && 77 === s.getUint8(l + 3) && 4 === s.getUint8(l + 4) && 4 === s.getUint8(l + 5))
					) {
	...
	var h = { 120: "caption", 110: "credit", 25: "keywords", 55: "dateCreated", 80: "byline", 85: "bylineTitle", 122: "captionWriter", 105: "headline", 116: "copyright", 15: "category" };
	function S(e, t, n) {
		for (var r, i, o, a, s = new DataView(e), l = {}, u = t; u < t + n; )
			28 === s.getUint8(u) &&
				2 === s.getUint8(u + 1) &&
				(a = s.getUint8(u + 2)) in h &&
				((o = s.getInt16(u + 3)) + 5, (i = h[a]), (r = y(s, u + 5, o)), l.hasOwnProperty(i) ? (l[i] instanceof Array ? l[i].push(r) : (l[i] = [l[i], r])) : (l[i] = r)),
				u++;
		return l;
	}
		...
		return (
			(r.thumbnail = (function (e, t, n, r) {
				var i,
					...
					a,
					s,
					l = ((o = t + n), (a = r), (s = (i = e).getUint16(o, !a)), i.getUint32(o + 2 + 12 * s, !a));
				if (!l) return {};
