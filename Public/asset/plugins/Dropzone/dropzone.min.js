!(function () {
	...
	var p = {
			...
			fallback: function () {
				...
				return (
					l && (null != l.textContent ? (l.textContent = this.options.dictFallbackMessage) : null != l.innerText && (l.innerText = this.options.dictFallbackMessage)),
			...
			addedfile: function (e) {
				if ((this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer && !this.options.disablePreviews)) {
					...
					this.options.addRemoveLinks &&
						((e._removeLink = f.createElement('<a class="dz-remove" href="javascript:undefined;" data-dz-remove>'.concat(this.options.dictRemoveFile, "</a>"))),
			...
			function o(n, r) {
				...
				return (
					...
					!1 !== l.options.previewsContainer &&
						(l.options.previewsContainer ? (l.previewsContainer = o.getElement(l.options.previewsContainer, "previewsContainer")) : (l.previewsContainer = l.element)),
				...
				r(
					...
					[
								...
								if (
									...
									this.element.classList.contains("dropzone") &&
										...
										this.element.appendChild(
											o.createElement('<div class="dz-default dz-message"><button class="dz-button" type="button">'.concat(this.options.dictDefaultMessage, "</button></div>"))
										),
									...
									this.clickableElements.forEach(function (e) {
										...
										return d.listeners.push({
											...
											events: {
												click: function (i) {
													return (
														(e !== t.element || i.target === t.element || o.elementInside(i.target, t.element.querySelector(".dz-message"))) && t.hiddenFileInput.click(),
														!0
													);
												},
											},
						...
						},
						{
							key: "removeFile",
							value: function (e) {
								if ((e.status === o.UPLOADING && this.cancelUpload(e), (this.files = m(this.files, e)), this.emit("removedfile", e), 0 === this.files.length))
						...
						},
						{
							...
							value: function (e, t, i) {
								...
								if (e[0].upload.chunked) {
									...
									i ? ((o.progress = (100 * i.loaded) / i.total), (o.total = i.total), (o.bytesSent = i.loaded)) : ((o.progress = 100), (o.bytesSent = o.total)),
										(c.upload.progress = 0),
										(c.upload.total = 0),
									...
									for (var l = 0; l < c.upload.totalChunkCount; l++)
										c.upload.chunks[l] &&
											...
											((c.upload.progress += c.upload.chunks[l].progress), (c.upload.total += c.upload.chunks[l].total), (c.upload.bytesSent += c.upload.chunks[l].bytesSent));
						...
						},
						{
							...
							value: function (e, t, i) {
								...
								if ((this.options.uploadMultiple && (this.emit("successmultiple", e, t, i), this.emit("completemultiple", e)), this.options.autoProcessQueue))
	...
	f.initClass(),
		...
		(f.dataURItoBlob = function (e) {
			for (
				var t = atob(e.split(",")[1]), i = e.split(",")[0].split(":")[1].split(";")[0], n = new ArrayBuffer(t.length), r = new Uint8Array(n), a = 0, o = t.length, l = 0 <= o;
				l ? a <= o : a >= o;
				l ? a++ : a--
			)
				r[a] = t.charCodeAt(a);
