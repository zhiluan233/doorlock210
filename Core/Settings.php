...
class Settings {
    ...
    public static function defaults()
    {
        return [
            ...
            'attendance_full_sync_batch_size' => '50',
            'attendance_recalculate_batch_size' => '200',
            ...
            'attendance_incomplete_message_enabled' => 'false',
            'attendance_incomplete_message_template' => '双验证考勤提醒',
            'attendance_incomplete_message_card_template' => "**考勤提醒** 还未完成双验证考勤\n**已完成** {done_method}\n**待完成** {missing_method}\n**截止时间** {deadline_datetime}\n请在截止前及时补{missing_method}。",
            'attendance_incomplete_message_lead_seconds' => '120',
            'attendance_incomplete_message_batch_size' => '50',
