...
<!DOCTYPE html>
    <html lang="zh-CN">
        <head>
            ...
            <script src="asset/js/ciPanel-register.js"></script>
        ...
        <body class="body-flex">
            <div class="container">
                <div class="afclogbox wrapper-flex fixdisplay" style="margin-top: 400px">
                    <div class="afc-bg">
                        <h1>CyberFurry ｜ 注册</h1>
                        <p class="afcfontwgt5 afcblock">请在右侧表单中填写你的信息</p>
                    </div>
    
                    <div class="main">
                        <form action="">
                            <p> <input type="input" placeholder="手机号(仅支持中国大陆)" id="phone"> </p>
                            <p> <input type="input" placeholder="设置昵称" id="nickname"> </p>
                            <p class="password">
                            ...
                            <p> <input type="input" placeholder="QQ" id="qq"> </p>
                            <input style="display: none" type=input id="captcha-token">
                            <div style="display: flex;justify-content: center;align-items: center;" class="g-recaptcha" data-sitekey=""></div>
                            <p><input id="code" type="input" placeholder="验证码"></p>
                            <p><input type="button" class="submit" value="获取短信验证码"  id="codeBtn"></p>
                            <p>点击“提交”按钮，即视为您已经仔细阅读并同意<a style="color: blue;" href="https://tailnet.cn/?page=yinyingzc"> 《服务协议》 </a>中的条款与相关规定。</p>
                            <p> <input type="button" class="submit afcfontwgt7" value="提交" id="signup"> </p>
                        </form>
                    </div>
